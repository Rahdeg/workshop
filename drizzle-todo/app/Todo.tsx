...
interface Props {
  todo: todoType;
  changeTodoText: (id: typeof todo.$inferSelect["id"], text: typeof todo.$inferSelect["text"]) => void;
  toggleIsTodoDone: (id: typeof todo.$inferSelect["id"], done: boolean) => void;
  deleteTodoItem: (id: typeof todo.$inferSelect["id"]) => void;
}
